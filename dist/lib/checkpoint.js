 ...
 */
export function saveCheckpoint(projectPath, worker, checkpoint) {
 ...
 */
export function loadCheckpoint(projectPath, worker) {
    const file = checkpointPath(projectPath, worker);
    if (!existsSync(file))
        return null;
    try {
 ...
 * @param worker       Worker name
 */
export function clearCheckpoint(projectPath, worker) {
    const file = checkpointPath(projectPath, worker);
    if (existsSync(file)) {
 ...
 * @param worker       Worker name
 */
export function canResume(projectPath, worker) {
