 ...
 */
export function generateMetaOrchestratorMd() {
 ...
 */
export function generateProjectOrchestratorMd(projectName, workers) {
 ...
 */
export function generateWorkerMd(projectName, workerName, role, domain, modelInfo) {
