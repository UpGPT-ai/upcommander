 ...
 * Currently only supports 'local' backend (filesystem).
 * Cloud backend support deferred until config module is implemented.
 */
export function createMemoryBackend(): MemoryBackend {
  // TODO: read memory_backend from ~/.claude-commander/config.json when config module exists
